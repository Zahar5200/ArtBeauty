"use strict";for(var markerBtn=document.querySelector(".marker-btn"),textArea=document.querySelector(".community__about-text"),chatLink=(markerBtn.addEventListener("click",function(){console.log("click"),textArea.focus()}),document.querySelectorAll(".chat__link")),chatList=document.querySelector(".chat__list"),chatTitle=document.querySelector(".chat__title"),chatItem=document.querySelectorAll(".chat__inner"),chatExit=document.querySelectorAll(".chat__el-btn"),s=0;s<chatExit.length;s++)chatExit[s].addEventListener("click",ExitChat);function ExitChat(){for(var t=0;t<chatExit.length;t++)chatItem[t].classList.add("chat__inner-hidden"),chatItem[t].classList.remove("chat__inner-active");chatList.classList.remove("chat__list-hidden"),chatList.classList.add("chat__list-active"),chatTitle.style.display="block"}for(var k=0;k<chatLink.length;k++)chatItem[k].classList.add("chat__inner-hidden"),chatItem[k].classList.remove("chat__inner-active"),chatLink[k].addEventListener("click",ChatLinkClick);function ChatLinkClick(t){chatTitle.style.display="none",chatList.classList.add("chat__list-hidden"),chatList.classList.remove("chat__list-active"),t.preventDefault(),t.target!==chatList&&(t=t.target.id,chatItem[t].classList.add("chat__inner-active"),chatItem[t].classList.remove("chat__inner-hidden"))}
"use strict";
"use strict";var swiper=new Swiper(".mySwiper",{effect:"cards",grabCursor:!0});
